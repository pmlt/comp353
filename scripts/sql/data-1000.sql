...
(3, 'A new take on LARL Parsers', 'Discuss a new spin on the old LARL parser algorithm.', 'lalr,parser,compiler', 12, 3, 'full', '2013-12-06 10:00:00', NULL),
(4, 'Interpreted programs: Who cares anymore?', 'With the latest advances in JIT compilation, are interpreters becoming old-fashioned?', 'interpreted,perl,php', 13, 3, 'short', '2013-12-06 11:00:00', NULL),
(5, 'The rise of functional programming', 'FP is becoming more and more common. Are we on the brink of an FP revolution?', 'functional,fp,haskell,scala', 14, 4, 'full', NULL, NULL),
(6, 'FORTRAN: The warrior that just will not go away', '40 years after its creation, FORTRAN remains a popular language among computer scientists. Why?', 'fortran,language', 15, 4, 'rejected', NULL, NULL),
(7, 'Aspect-oriented programming: OOP on steroids', 'There is no question that OOP remains the most popular paradigm today. But it is about to get even better soon.', 'aspect,object,trait,mixin', 8, 4, 'workshop', NULL, NULL),
